...
class Batch(object):
    def __init__(self, examples, grammar, vocab, cuda=False,copy=True):
        self.examples = examples
        ...
        self.vocab = vocab
        self.cuda = cuda
        self.copy=copy #whether there is copy information available
                ...
                if t < len(e.tgt_actions):
                    ...
                    if isinstance(action, ApplyRuleAction):
                        ...
                        if not action_info.copy_from_src:
                            ...
                            if self.copy: #whether there is copy information available
                                copy_mask = 1
                                ...
                                try:
                                    copy_pos = e.src_sent.index(action.token)
                                    copy_mask = 1
                                except:
                                    pass
                                if (not copy_mask) or token_idx != self.vocab.primitive.unk_id:
                                    gen_token_mask = 1
